...
public class ActivityContacto extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Spinner spGeneros = findViewById(R.id.generos_ct);
        ...
        Button btnGuardar = findViewById(R.id.btnGuardar_ct);
        ...
        Button btnPicker = findViewById(R.id.btnPicker_ct);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == PICK_IMAGE_REQUEST && resultCode == RESULT_OK && data != null && data.getData() != null) {
            ...
            try {
                ...
                ImageView imageView = findViewById(R.id.imgPersona_ct);
    ...
    private void iniciarProcedimiento_1() {
        EditText edtNombre = findViewById(R.id.edtNombre_ct);
        EditText edtApellido = findViewById(R.id.edtApellido_ct);
        EditText edtTelefono = findViewById(R.id.edtTelefono_ct);
        EditText edtEdad = findViewById(R.id.edtEdad_ct);
        EditText edtCorreo = findViewById(R.id.edtCorreo_ct);
        Spinner spGenero = findViewById(R.id.generos_ct);
        ...
        Contacto obj = new Contacto(nombre, apellido, telefono, Integer.valueOf(edad), sexo.charAt(0), correo, Utiles.comprimir(bitmap));
    ...
    private Long guardar(Contacto obj) {
        Long id = -1l;
        ...
        try {
            ...
            id = db.insert(Transacciones.tabla_concacto, Transacciones.id, valores);
